        ...
        <div>
          ...
          <div className="row row-cols-1  g-0 my-5"  >
            <div className='d-flex justify-content-center p-2'>
              ...
              <input style={{ maxWidth: "3000px", height: "50px", border: "4px solid #ff58b9", borderRadius: "10px" }}
                type="text"
                  ...
                  <div className="card m-4  " style={{ maxWidth: "300px" }}  >
                    ...
                    <div className="card-body">
                      ...
                      <div className='d-flex justify-content-center'>
                        ...
                        <button className='btn btn-info'><NavLink style={{ color: "white", textDecoration: "none" }} to={`/flower/${flower._id}`}>show <FaArrowRightLong /></NavLink>
                        </button>
                      </div>
                    </div>
