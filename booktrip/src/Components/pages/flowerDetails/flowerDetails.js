    ...
    <div className="container my-5 shadow-lg p-3 mb-5 bg-body-tertiary rounded">
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <div className="d-flex justify-content-center mt-1 "><button className="button my-5" onClick={handleAddToCart}><NavLink style={{ color: "white", textDecoration: "none" }} to={`/cart`}>Add to cart</NavLink>
